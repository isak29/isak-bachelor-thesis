...
Organisationer består av flera interna system med mängder av data såsom projektverktyg, dokumentation, kommunikationskanaler och information om anställda.
Denna spridning av information leder till att anställda spenderar onödigt mycket tid dagligen på att leta efter intern information.

Detta arbete undersöker därför hur data från interna system kan representeras för att ge en LLM den kontext den behöver för att navigera och hämta denna interna information och på så sätt effektivisera informationssökning inom en organisation.
Primärt undersöks om en grafbaserad datarepresentation i form av en kunskapsgraf ger LLM:er bättre förutsättningar att kombinera information från flera olika källor jämfört med en API-baserad lösning.
...
Resultaten visar att den grafbaserade lösningen presterar bättre vid komplexa frågor som kräver att det görs kopplingar mellan data från olika källor.
Där hade lösningen korrekta svar på 80\% av frågorna mot API-baserade lösningens 20\% korrekta svar. Den grafbaserade lösningen hade även i genomsnitt 2,4 verktygsanrop mot API-baserades 6.
Vid de simplare frågorna presterade lösningarna i genomsnitt likvärdigt.

Slutsatsen är att en grafbaserad representation ger LLM:en tydliga fördelar med att kombinera information från olika källor, medan den aPI-baserade lösningen är tillräcklig för att besvara frågor som rör enskilda källor.
