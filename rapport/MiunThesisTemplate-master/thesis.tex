...
\hyphenation{grafbaserad APIbaserad datarepresentation dataåtkomst informationssökning organisationer resursanvändning effektivitet}


\title{Datarepresentation för LLM-driven informationssökning i organisationer}
