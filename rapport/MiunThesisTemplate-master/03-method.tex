...
I den första fasen undersöks och identifieras de problem som finns med dagens informationshantering inom organisationer.
Fasen består av en litteraturstudie och analys av befintliga problem och potentiella lösningar. Det undersöks relevanta tekniker och metoder
...
Det blir här tydligt att målet är att utveckla ett system som låter en LLM kommunicera med och hämta data från en grafdatabas, samt att bygga ett system där LLM:en direkt hämtar från externa källornas API:er, för att ha något att jämföra med.
...
Här skrivs koden för MCP servern och uppkopplingen till databasen och API:erna i TypeScript, och integrationen med LLM:en och MCP servern etableras i Cherry Studio.
...
Detta möjliggör en analys av skillnaderna mellan de två lösningarna, och därmed besvara forskningsfrågorna och dra en slutsats.
