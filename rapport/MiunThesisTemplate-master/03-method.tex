...
Här skrevs koden för MCP servern och uppkopplingen till databasen och API:erna i TypeScript, och integrationen med LLM:en och MCP servern etablerades i Cherry Studio.
Systemet byggdes iterativt där olika delar utvecklades och testades allt eftersom. 
Det lades till nya verktyg och ny funktionalitet under utvecklingens gång då nya behov upptäcktes.
...
I den sista fasen utvärderades systemet. Här identifierades möjliga ändringar som hade kunnat implementerats i systemen. Exempelvis fler verktyg för att hämta mer specifik information, eller en mer avancerad design av grafdatabasen.
Det diskuterades även om framtida forskning och vidare utveckling av systemen, såsom exempelvis automatisk uppdatering och skapande av grafdatabasen. 
