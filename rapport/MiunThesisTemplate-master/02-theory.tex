...
Det inkluderar både forskning inom området för datasilos, kunskapsgrafer och användning av LLM:er i informationssökning.

\subsubsection{Datasilos}
\subsubsection{Kunskapsgrafer}
\subsubsection{LLM:er i informationssökning}