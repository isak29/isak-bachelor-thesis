...
Avgränsningarna i kapitel \ref{subsec:scope} gjorde det inte möjligt att skapa ett komplett system där LLM:en själv hämtar och uppdaterar data i grafdatabasen.
