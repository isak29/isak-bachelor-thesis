...
Varje meddelande skickas till LLM:en som en samling av systemprompten, verktygslistan och chatthistoriken (Om det finns tidigare meddelande i samma session).
...
Vid varje test mäts korrekthet, tid, antal verktygsanrop samt om modellen behöver ställa följdfrågor.
