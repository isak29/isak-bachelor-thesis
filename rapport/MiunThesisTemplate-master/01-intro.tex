...
Projektet syftar till att undersöka hur organisatorisk information kan representeras för att med hjälp av LLM:er effektivisera intern informationssökning inom en organisation.
...
Enligt en studie från IDC (International Data Corporation) citerad i \cite{armedia} visas det att en kunskapsarbetare i genomsnitt spenderar upp till 2,5 timmar per dag att söka information, vilket motsvarar ungefär 30\% av en vanlig arbetsdag.
...
Arbetet inkluderar:
\begin{itemize}
  \item {Skapande av en kunskapsgraf som lagras i en grafdatabas, backend med MCP server för att låta LLM:en prata med grafdatabasen och användning av ett användargränssnitt med integrerad LLM för att tolka användarinmatning}
