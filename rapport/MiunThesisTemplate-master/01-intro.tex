...
Syftet med arbetet är att undersöka hur organisatorisk information kan rpresenteras för att effektivisera informationssökning med hjälp av LLM:er.
Detta görs genom att utveckla och jämföra två olika system: en grafbaserad och en API-baserad lösning för att utvärdera hur representation av data påverkar en LLM:s förmåga att navigera och hämta information inom en organisation. 
...
Arbetet inkluderar:
\begin{itemize}
  \item {Skapande av en kunskapsgraf som lagras i en grafdatabas, backend med MCP server för att låta LLM prata med grafdatabasen, och användning av ett användargränssnitt med integrerad LLM för att tolka användarinmatning}
